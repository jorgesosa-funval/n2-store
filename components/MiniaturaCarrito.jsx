...
export default function MiniaturaCarrito() {
    return (
        <>
            <div className="z-50 bg-white p-3 w-[300px] text-[10px] border divide-y divide-gray-100">
                ...
                <p className="text-end">Total pagar: <span className="font-bold">$4500</span></p>
